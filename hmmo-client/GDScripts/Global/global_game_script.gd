...
var Global_Server_List:PackedStringArray = []
...
func generate_nickname() -> String:
	var adjectives = [
	"Смелый", "Быстрый", "Умный", "Сильный", "Храбрый",
	"Весёлый", "Тихий", "Громкий", "Маленький", "Большой",
	"Ловкий", "Мудрый", "Добрый", "Злой", "Хитрый",
	"Грозный", "Могучий", "Свирепый", "Бесстрашный", "Неистовый",
	"Таинственный", "Загадочный", "Мрачный", "Сияющий", "Блистательный",
	"Острый", "Гибкий", "Выносливый", "Благородный", "Верный",
	"Преданный", "Любопытный", "Озорной", "Серьёзный", "Решительный",
	"Стремительный", "Умелый", "Искусный", "Дерзкий", "Стойкий",
	"Непобедимый", "Всесильный", "Проворный", "Шустрый", "Яркий",
	"Тёмный", "Светлый", "Древний", "Молодой", "Вечный",
	"Жуткий", "Зловещий", "Кошмарный", "Пугающий", "Страшный",
	"Могильный", "Потусторонний", "Кровавый", "Готический", "Паучий",
	"Ведьмовской", "Вампирский", "Призрачный", "Загробный", "Ночной",
	"Ужасный", "Трупный", "Скелетный", "Пепельный", "Лунный"];
	var nouns = [
	"Волк", "Лис", "Медведь", "Орёл", "Тигр",
	"Дракон", "Рыцарь", "Маг", "Вор", "Стрелок",
	"Пантера", "Ястреб", "Кот", "Пёс", "Единорог",
	"Ворон", "Сокол", "Барс", "Леопард", "Змей",
	"Грифон", "Феникс", "Кентавр", "Эльф", "Гном",
	"Викинг", "Самурай", "Ниндзя", "Пират", "Ковбой",
	"Шериф", "Индеец", "Авантюрист", "Искатель", "Хранитель",
	"Страж", "Паладин", "Чародей", "Колдун", "Шаман",
	"Друид", "Охотник", "Следопыт", "Воин", "Боец",
	"Призрак", "Демон", "Ангел", "Вампир", "Оборотень",
	"Жнец", "Скелет", "Тыква", "Паук", "Летучая мышь",
	"Ведьма", "Зомби", "Гоблин", "Упырь", "Вурдалак",
	"Кошмар", "Ужас", "Мрак",
	"Кладбище", "Склеп", "Гроб", "Череп", "Свет",
	"Могила", "Привидение", "Полтергейст", "Монстр", "Оборотень"];
